...
#     model=genai.GenerativeModel('generative-pro-vision')
#     response=model.generate_content([input, pdf_content[0], prompt])
#     return response.text

# def input_pdf_setup(uploaded_file):
#     if uploaded_file is not None:## Convert PDF-to-image
#         images=pdf2image.convert_from_bytes(uploaded_file.read())
#         first_page=images[0]

#         img_byt_arr=io.BytesIO()
#         first_page.save(img_byt_arr, format='JPEG')
...
# input_prompt1="""
#  You are an experienced Technical HR with tech experience in the field of Data Science, Full Stack 
